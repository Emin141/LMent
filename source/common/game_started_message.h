...
/* ------------------------------------------------------------------------------------------------------------------ */
inline sf::Packet& operator>>(sf::Packet& packet, GameStartedMessage::InitialPlayerInfo& initialPlayerInfo) {
    return packet >> initialPlayerInfo.id >> initialPlayerInfo.position;
}
/* ------------------------------------------------------------------------------------------------------------------ */
inline sf::Packet& operator<<(sf::Packet& packet, const GameStartedMessage::InitialPlayerInfo& initialPlayerInfo) {
    return packet << initialPlayerInfo.id << initialPlayerInfo.position;
}
/* ------------------------------------------------------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------------------------------------------------------ */
inline sf::Packet& operator<<(sf::Packet& packet, const GameStartedMessage& message) {
    return packet << message.thisPlayerId << message.initialPlayerInfoList;
}
/* ------------------------------------------------------------------------------------------------------------------ */